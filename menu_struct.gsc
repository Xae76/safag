addMenu(menuId, menuTitle, description, parentMenu)
{
    self.menu[menuId] = [];
    self.menu[menuId]["title"] = menuTitle;
    self.menu[menuId]["desc"] = description;
    self.menu[menuId]["parent"] = parentMenu;
    self.menu[menuId]["options"] = [];
}
